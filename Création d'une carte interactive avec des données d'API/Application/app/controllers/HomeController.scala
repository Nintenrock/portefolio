...
import com.sun.org.apache.bcel.internal.generic.GOTO._
...
import scala.reflect.internal.ClassfileConstants.goto
...
class HomeController @Inject()(val controllerComponents: ControllerComponents) extends BaseController {
  ...
  def getAcountry(countryName: String) = Action { implicit request: Request[AnyContent] =>
    ...
    var correspondingObject = List(jsCountriesList(0)(countryName) \ "All")
    ...
    correspondingObject = List(jsVaccinsList(0)(countryName) \ "All")
